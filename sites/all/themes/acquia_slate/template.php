...
function phptemplate_preprocess_page(&$vars) {
  ...
  if (drupal_is_front_page()) {
    $vars['closure'] .= '<div id="legal-notice">&nbsp;</div>';


/**  $vars['closure'] .= '<div id="legal-notice">Theme provided by 
* <a href="http://www.acquia.com">Acquia, Inc.</a> under GPL license from TopNotchThemes
* <a href="http://www.topnotchthemes.com">Drupal themes</a></div>';
*/
  }
}
