...
<html xmlns="http://www.w3.org/1999/xhtml" lang="<?php print $language->language; ?>" xml:lang="<?php print $language->language; ?>">
 ...
 // if( $title == "Contact" ){ $title = "Contact test";}
?>
        ...
        <div id="content-wrapper">
          ...
          <div id="content">
            ...
            <div id="content-inner" class="clear">
              <?php if ($title): ?>
              <?php $class="title"; ?>
              <?php if(strtolower($title)=='contact'){$class="contact_us";$title='&nbsp;';}?>
              <?php if(strtolower($title)=='exhibitions'){$class="exhibitions";$title='&nbsp;';}?>
              <?php if(strtolower($title)=='concepts'){$class="concepts";$title='&nbsp;';}?>
			  <?php if(strtolower($title)=='bio'){$class="bio";$title='&nbsp;';}?>
              <h1 class="<?php print $class; ?>"><?php print $title; ?></h1>
              <?php endif; ?>
              <?php if ($content): ?>
              <?php print $content; ?>
              <?php endif; ?>
